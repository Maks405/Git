...
public class JournalAppGUI extends JFrame {
    ...
    public JournalAppGUI(Group group) {
        ...
        JButton btnAddDiscipline = new JButton("Додати дисципліну студенту");
        JButton btnAddGrade = new JButton("Виставити оцінку студенту");
    ...
    private void addStudent() {
        String fullName = JOptionPane.showInputDialog(this, "Введіть прізвище, ім'я по батькові (за бажанням) студента:");
